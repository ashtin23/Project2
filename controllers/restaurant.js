...
module.exports = {
  ...
  show: function(req, res) {
    Restaurant.findOne({ restaurant_id: req.params.restaurant_id }).then(
      restaurant => res.json(show)
    );
  },
  showName: function(req, res) {
    Restaurant.findOne({ restaurant_name: req.params.restaurant_name }).then(
